...
subtest "add_email numbered params" => sub {
    ...
    my ( @csv1, @csv2);
    Text::AutoCSV->new( in_file => $sample_file,  walker_ar => sub { push @csv1, shift; } )->read();
    ...
    Text::AutoCSV->new( in_file => 't/samples/p_addresses.csv', walker_ar => sub { push @csv2, shift; } )->read();
